...
<header class="headertop">
    <div class="container">
        ...
        <div class="upload dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="addpedigree">ADD PEDIGREE</a>
    ...
    <nav class="navbar navbar-expand-md navbar-dark">
        <div class="container">
            ...
            <a class="navbar-brand" href="https://imaxims.com/germanshep">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="https://imaxims.com/germanshep">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    @if(session()->has('name'))
                        <li class="nav-item logout">
                            <a class="" href="userdetail"> {{ session()->get('name') }} </a>  <span class="text-light">|</span>  <a class="" href="logout">Logout</a>  <span class="text-light">|</span>  <a class="" href="manage-pedigree">Manage</a>
                        </li>
                    @else
                    <li class="nav-item logout">
