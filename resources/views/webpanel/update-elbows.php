...
if (isset($_POST['blog_post'])) {
    ...
    $que = "update hips_elbow set hips_desc='$title' where hdb = '$channel_id'";

//print_r($que);
//exit();
    $query = mysqli_query($con, $que);
    $_SESSION['msg'] = "Page Updated successfully";
    $extra = "manage-elbows.php";
...
<section id="container">
    ...
    $sqlblog = "Select * from hips_elbow where hdb = '$blog_id'";
                            ...
                            <ul>
                                ...
                                <li><strong>Title:</strong><br>
                                    <input class="input form-control" type="text" name="title"
                                           value="<?php echo $blogdet["hips_desc"]; ?>"></li>
