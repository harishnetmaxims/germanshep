...
// for Inser Blog info
    if (isset($_POST['blog_post'])) {
        ...
        $que = "update blog_categories set category_name='$title' where category_id = '$channel_id'";
...
<section id="container">
    ...
    $sqlblog = "Select * from blog_categories where category_id = '$blog_id'";
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> <?php echo $blogdet['category_name']; ?>'s Information</h3>
                ...
                <div class="col-md-12">
                    <div class="content-panel">
                        ...
                        <form method="post" name="blog_form" id="blog_form" action="" enctype="multipart/form-data">
                            ...
                            <ul>
                                <input type="hidden" name="uid" value='<?php echo $blogdet["category_id"]; ?>'>
                                <li><strong>Title:</strong><br>
                                    <input class="input form-control" type="text" name="title"
                                           value="<?php echo $blogdet["category_name"]; ?>"></li>
