...
if (isset($_GET['id'])) {
    ...
    $msg = mysqli_query($con, "delete from dp_koer where id='$pageid'");
    if ($msg) {
...
<section id="container">
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="logout" style="float:right;"><a href="add-koer.php">
                    ...
                    <div class="content-panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            <div class="col-md-12" style="padding:0px;">
                                ...
                                $total_pages_sql = "SELECT COUNT(*) FROM dp_koer ";
                                $result = mysqli_query($con, $total_pages_sql);
                                $total_rows = mysqli_fetch_array($result)[0];
                                $total_pages = ceil($total_rows / $no_of_records_per_page);

                                $ret = mysqli_query($con, "select * from dp_koer ORDER BY title ASC  LIMIT $offset, $no_of_records_per_page");
                                ...
                                while ($row = mysqli_fetch_array($ret)) {
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">
                                            <a href="update-koer.php?uid=<?php echo $row['id']; ?>">
                                                <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>
                                                </button>
                                            </a>
                                            <a href="manage-koer.php?id=<?php echo $row['id']; ?>">
                                                <button class="btn btn-danger btn-xs"
                                                        onClick="return confirm('Are you sure you want to delete koer <?php echo $row['title']; ?>');">
