...
{
$que="update group_profile set group_name='$title', group_description='$description', public_private='$private_pub' where indexer = '$user_id'";

} else {
$que="update group_profile set group_name='$title', group_description='$description', public_private='$private_pub', image_pro='$image' where indexer = '$user_id'";
  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php
		 $sqlblog = "Select * from group_profile where indexer = '$blog_id'";
        ...
        ?>
         ...
         <ul>
            ...
            <li><strong>ID:</strong><br>
                <input class="input form-control" type="text" name="breeder_id" value="<?php echo utf8_decode($blogdet["breeder_id"]); ?>" disabled="disabled"></li>

            <li><strong>Title:</strong><br>
                <input class="input form-control" type="text" name="group_name" value="<?php echo utf8_encode($blogdet["group_name"]); ?>"></li>
            ...
            <li><strong>Public / Private:</strong><br>
              ...
              <li><strong>Description:</strong><br>
                 <textarea  class="form-control summernote"  name="group_description" value=""><?php echo utf8_encode($blogdet["group_description"]); ?></textarea>
                 </li>
   ...
   <? if($blogdet["image_pro"]){?> <img src="../uploads/thumbs/<?php echo $blogdet["image_pro"] ?>" id="profile-img-tag" width="100px" /><? }else{?>
   ...
   <? }?>
             ...
             <li>
               <input type="submit" class="btn btn-theme" value="Update Breeder" name="blog_post">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <a href="manage-breeder.php?id=<?php echo $blogdet['indexer'];?>">
                                    <button type="button" class="btn btn-theme" onClick="return confirm('Are you sure you want to delete breeder <?php echo $blogdet['group_name'];?>');">Delete Breeder</button></a>
