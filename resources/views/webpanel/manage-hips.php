...
if (isset($_GET['id'])) {
    ...
    $msg = mysqli_query($con, "delete from hips where hdb='$pageid'");
    if ($msg) {
...
<section id="container">
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="logout" style="float:right;"><a href="add-hips.php">
                    ...
                    <div class="content-panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            <div class="col-md-12" style="padding:0px;">
                                ...
                                $total_pages_sql = "SELECT COUNT(*) FROM hips ";
                                $result = mysqli_query($con, $total_pages_sql);
                                $total_rows = mysqli_fetch_array($result)[0];
                                $total_pages = ceil($total_rows / $no_of_records_per_page);

                                $ret = mysqli_query($con, "select * from hips ORDER BY hdb DESC  LIMIT $offset, $no_of_records_per_page");
                                ...
                                while ($row = mysqli_fetch_array($ret)) {
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">
                                            <a href="update-hips.php?uid=<?php echo $row['hdb']; ?>">
                                                <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>
                                                </button>
                                            </a>
                                            <a href="manage-hips.php?id=<?php echo $row['hdb']; ?>">
