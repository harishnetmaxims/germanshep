...
if(isset($_POST['blog_post']))
{
   ...
   $que="update hips set hips_desc='$title' where hdb = '$channel_id'";
...
<html lang="en">
  ...
  <section id="container" >
	  ...
	  include'include/side.php';
		...
		$sqlblog = "Select * from hips where hdb = '$blog_id'";
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> <?php echo $blogdet['hips_desc'];?>'s Information</h3>
        ...
        ?>
         ...
         <ul>
             <input type="hidden" name="uid" value='<?php echo $blogdet["hdb"]; ?>'>
            <li><strong>Title:</strong><br>
                <input class="input form-control" type="text" name="title" value="<?php echo $blogdet["hips_desc"]; ?>"></li>
